...
const Footer = () => {
  return (
    <div className="w-full h-screen bg-zinc-900 p-20 flex font-['Founders Grotesk']">
      <div className="w-1/2  h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[6vw] -mb-4 font-bold uppercase leading-none">
            Eye-
          </h1>
          <h1 className="text-[6vw] -mb-4 font-bold uppercase leading-none">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw]  font-bold uppercase leading-none">
          Presentations
        </h1>
        <div>
          <p className="block text-[24px]    font-['Neue Montreal'] mt-5">s:</p>
          <div className="dets font-['Neue Montreal']">
            {["FaceBook", "Instagram", "Twitter"].map((item, index) => (
              <div key={index} className="block text-[18px] underline mb-1">
                {item}
              </div>
            ))}
          </div>
        ...
        <div>
          <p className="block text-[24px]    font-['Neue Montreal'] mt-5">L:</p>
          <div className="dets font-['Neue Montreal']">
            {["202-1965 W 4th A", "Vancouver, Canada", "30 Chukarina St"].map(
              (item, index) => (
                <div key={index} className="block text-[18px] underline mb-1">
                  {item}
                </div>
